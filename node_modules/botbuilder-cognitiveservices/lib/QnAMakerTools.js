    ...
    function QnAMakerTools() {
        ...
        this.lib.dialog('answerSelection', [
            function (session, args) {
                ...
                //qnaMakerResult.answers.forEach(function { questionOptions.push(qna.questions[0]); });
                //qnaMakerResult.answers.questionOptions.push(qna.questions['Search Again']); 
                var promptOptions = { listStyle: builder.ListStyle.button };
                builder.Prompts.choice(session, "Please select from the following or type 'search again':", questionOptions, promptOptions);
            },
            function (session, results) {
                ...
                selectedQnA.answer); // Added by DC
                //session.send(session.message.text);
                //session.send(selectedQnA.answer);
                console.log('Returned Questions - ' + session.privateConversationData.qnaFeedbackUserQuestion);
                console.log('Returned Questions 2 - ' + results.response.entity);
